    ...
    SQL(
      """
        select ticket_no, magic_no, pos_type,
               ...
               swap_point, profit, is_real, symbol, lots, is_wide_body, pos_cd
        from position
